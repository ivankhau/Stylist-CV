...
//  Hair CV
//
//  Created by Ivan Khau on 4/14/16.
...
public class SwiftLoader: UIView {
    ...
    class SwiftLoadingView : UIView {
        ...
        private func drawBackgroundCircle(partial : Bool) {
            ...
            let radius : CGFloat = (CGFloat(self.bounds.size.width) - CGFloat(self.lineWidth!)) / CGFloat(0.35)
            
            let processBackgroundPath : UIBezierPath = UIBezierPath()
            processBackgroundPath.lineWidth = CGFloat(self.lineWidth!)
            
            if (partial) {
                endAngle = (1.75 * CGFloat(M_PI)) + startAngle
            }
    ...
    public struct Config {
         ...
         *  Size of loader
         */
        public var size : CGFloat = 60.0
        
        /**
         *  Color of spinner view
         */
        public var spinnerColor = UIColor.darkTextColor()
         ...
         *  Foreground color
         */
        //public var foregroundColor = UIColor(red: 76.0/255.0, green: 106.0/255.0, blue: 146.0/255.0, alpha:1)

        
        public var foregroundColor = UIColor.blackColor()
        
        /**
         *  Foreground alpha CGFloat, between 0.0 and 1.0
         */
        public var foregroundAlpha:CGFloat = 0.30
...
func actionShowLoader() {
    ...
    let config : SwiftLoader.Config = SwiftLoader.Config()
